...
"""
        ...
        with gr.Group(elem_classes="rhk-card"):
            ...
            risk_out = gr.HTML(value=render_risk_html({}, {}, {}, dash_html="<div class='muted'>Noch kein Befund erstellt. Bitte oben oder unten auf <b>Befund erstellen</b> klicken.</div>"))
